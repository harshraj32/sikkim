  ...
  */
  ...
  function redrawArticleList(articles) {
    ...
    articles.forEach(function(currentArticle) {
      ...
      if (currentArticle.doc.author > 0) {
        $('#article-list').append("<li class='article " + completedClass+  "'><strong>" + wingding + " &nbsp; &nbsp; &nbsp;  <a href='#"+currentArticle.doc._id +"'>"+currentArticle.doc.title+"</a></strong> (" +currentArticle.doc.author + ")</li>");
      //if not, leave out
      } else {
        $('#article-list').append("<li class='article " + completedClass+ "'><strong>" + wingding + "  &nbsp; &nbsp; &nbsp; <a href='#"+currentArticle.doc._id +"'>"+currentArticle.doc.title+"</a></strong> </li>");
      }
  ...
  function saveArticle() {
    ...
    if (validateForm()) {
      ...
      var article = {
        ...
        objectType: "student", //  will allow me to later have other types of objects (people, etc. in same DB)
